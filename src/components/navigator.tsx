			...
			<ul className="flex font-medium text-slate-900">
				...
				<li>
					...
					>
						...
						{count > 0 && (
							<span className="absolute -top-1 right-0 w-6 h-6 flex items-center justify-center rounded-full border-2 border-orange-500 bg-white font-medium text-orange-500">
								{count}
							</span>
						)}
					</button>
				...
				<li>
					<Popover open={open} onOpenChange={setOpen}>
						<PopoverTrigger asChild>
							<div
								className={clsx(
									"group flex items-end rounded-full px-4 py-2 transition",
									{
										"hover:bg-slate-100":
						...
						<PopoverContent>
							<button
								...
								disabled={isPending}
							>
								<span className="font-semibold text-slate-600">新規・編集</span>
							...
							<button
								...
								disabled={isPending}
							>
								<span className="font-semibold text-slate-600">再ログイン</span>
								<span className="px-1 text-sm text-slate-400">
									LINEのプロフィールを変更した場合
								</span>
							</button>
							<button
								...
								disabled={isPending}
							>
								<span className="font-semibold text-slate-600">友だち追加</span>
								<span className="px-1 text-sm text-slate-400">
									Botを別のグループトークで利用
								</span>
							</button>
							<button
								...
								disabled={isPending}
							>
								<span className="font-semibold text-slate-600">概要</span>
							</button>
						</PopoverContent>
					</Popover>
				</li>
