...
export async function upsertUser(sub: string, name: string, picture?: string) {
...
export async function overallAttendanceDetail(
	scheduleId: number,
...
export async function personalAttendance(userId: string, scheduleId: number) {
